...
import { isSVG } from './svg-utils.js';
import supportedFormats from './get-supported-formats.js';
 ...
 */
export default async function fetchImage(...urls) {
	let options;
...
async function fetchSingleImage(url, options) {
	...
	let type = await FileType.fromBuffer(body);
